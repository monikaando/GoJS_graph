...
;define("monika-swidzinska-value-blue/templates/components/editor", ["exports"], function (_exports) {
  "use strict";
...
;
          if (!runningTests) {
            require("monika-swidzinska-value-blue/app")["default"].create({"name":"monika-swidzinska-value-blue","version":"0.0.0+9e4a8bd7"});
          }
